...
if (isset($_POST['submit'])) 
{
    ...
    $sql = "SELECT r_id, email_id, password, user_type FROM registration_table WHERE email_id = '$email_id' && password = '$password'";
    ...
    if (mysqli_num_rows($result) > 0) 
    {
        ...
        if($row['user_type'] == 'admin'){
       	...
       	header("location:admin.php?r_id=".$row['r_id']."");
    ...
    elseif($row['user_type'] == 'user')
    {
         ...
         $_SESSION['user_name'] = $row['name'];
       	header("location:user_page.php?r_id=".$row['r_id']."");
